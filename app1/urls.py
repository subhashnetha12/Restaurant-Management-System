...
urlpatterns = [    
    ...
    path('inventory/items/quick-create/', inventory_views.inventory_quick_create, name='inventory_quick_create'),
    ...
    path('inventory/vendors/<int:pk>/ledger/', inventory_views.vendor_ledger, name='vendor_ledger'),
    ...
    path('inventory/purchases/<int:pk>/payments/add/', inventory_views.purchase_payment_add, name='purchase_payment_add'),
